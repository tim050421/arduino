...
//    unsigned char msg[8] = {0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
//    if(brut < 0x600) {
//      if(brut != 0x3ca)
...
//    }
  unsigned int pIds[38] = {0x10, 0x15, 0x20, 0x30, 0x3a, 0xe0, 0xfa, 
                           ...
                           0x311,0x326,0x35c,0x3a2,0x3b2,0x3ca,0x3f0,
  ...
  unsigned char pData[38][8] = {
    ...
    {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},      // 0x311
